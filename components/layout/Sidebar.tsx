...
export default function Sidebar({ open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed left-0 top-0 z-40 flex min-h-screen sticky top-0 w-72 flex-col bg-green-900 p-5 text-white shadow-2xl transition-transform duration-300 md:static md:w-64 md:translate-x-0 md:shadow-none ${
